...
func (ps *PodState) score(nodeInfo *framework.NodeInfo) (int64, *framework.Status) {
	...
	klog.Infof("[lxyscore] node '%s' terminatingPodNum: %d  nominatedPodNum: %d  score: %d", nodeInfo.Node().Name, nominatedPodNum, terminatingPodNum, terminatingPodNum - nominatedPodNum)
