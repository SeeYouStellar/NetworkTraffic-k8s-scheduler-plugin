...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NetworkTrafficArgs)(nil), (*config.NetworkTrafficArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_NetworkTrafficArgs_To_config_NetworkTrafficArgs(a.(*NetworkTrafficArgs), b.(*config.NetworkTrafficArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NetworkTrafficArgs)(nil), (*NetworkTrafficArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NetworkTrafficArgs_To_v1beta1_NetworkTrafficArgs(a.(*config.NetworkTrafficArgs), b.(*NetworkTrafficArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_NetworkTrafficArgs_To_config_NetworkTrafficArgs(in *NetworkTrafficArgs, out *config.NetworkTrafficArgs, s conversion.Scope) error {
	...
	if err := v1.Convert_Pointer_int64_To_int64(&in.TimeRangeInSeconds, &out.TimeRangeInSeconds, s); err != nil {
		return err
	}
	return nil
}
...
func Convert_v1beta1_NetworkTrafficArgs_To_config_NetworkTrafficArgs(in *NetworkTrafficArgs, out *config.NetworkTrafficArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_NetworkTrafficArgs_To_config_NetworkTrafficArgs(in, out, s)
}
...
func autoConvert_config_NetworkTrafficArgs_To_v1beta1_NetworkTrafficArgs(in *config.NetworkTrafficArgs, out *NetworkTrafficArgs, s conversion.Scope) error {
	...
	if err := v1.Convert_int64_To_Pointer_int64(&in.TimeRangeInSeconds, &out.TimeRangeInSeconds, s); err != nil {
		return err
	}
	return nil
}
...
func Convert_config_NetworkTrafficArgs_To_v1beta1_NetworkTrafficArgs(in *config.NetworkTrafficArgs, out *NetworkTrafficArgs, s conversion.Scope) error {
	return autoConvert_config_NetworkTrafficArgs_To_v1beta1_NetworkTrafficArgs(in, out, s)
}
...
func autoConvert_config_NodeResourceTopologyMatchArgs_To_v1beta1_NodeResourceTopologyMatchArgs(in *config.NodeResourceTopologyMatchArgs, out *NodeResourceTopologyMatchArgs, s conversion.Scope) error {
	// WARNING: in.ScoringStrategy requires manual conversion: inconvertible types (sigs.k8s.io/scheduler-plugins/pkg/apis/config.ScoringStrategy vs *sigs.k8s.io/scheduler-plugins/pkg/apis/config/v1beta1.ScoringStrategy)
	return nil
}
